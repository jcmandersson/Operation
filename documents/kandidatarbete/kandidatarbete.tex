...
En funktion för backup finns och funktionaliteten går att utveckla med nuvarande api.%Bra om nån med koll fyller på
...
\item[Redigering av handböcker] I nuvarande system kan flera personer redigera en handbok samtidigt. Ett lås skulle kunna implementeras för att lösa detta.
\item[Förhandstitt] I nuvarande system öppnas en ny flik vid förhandstitt. Detta upplevdes vid användartester som något förvirrande.
\item[Borttagning av handbok] I dagsläget går det inte ta bort en handbok. Detta bör vara enkelt att implementera.
\item[Handbok till pdf] %skriv vad som kan ändras
\item[Redigering av kartotekartikel] Det är svårt att redigera ett fält i kartoteket som är tomt. Själva rutan är för lite och det är svårt att pricka rätt.
\item[Varning] Det går inte att spara en artikel i kartoteket då pris inte angivits. Användaren får dock ingen varning eller information om detta vilket leder till frustration.
