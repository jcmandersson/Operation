...
%TODO bild på alpa state cards

\subsubsection{Kundmöten}
Efter varje iteration så har man på plats hos kunden haft ett möte för att diskutera hur arbetet fortskrider, detta är ett perfekt tillfälle
och även om någon missuppfattning har uppdagats.
...
När den första iterationen skulle inledas så kände samtliga i gruppen att kodstugorna hade fungerat bra och att det kändes naturligt att fortsätta arbetet på detta sätt.
