...
Här beskrivs hur utvecklingen i projektet har gått till väga och vilka hjälpmedel som har använts för att underlätta arbetet.
...
När den första iterationen skulle inledas så kände samtlige i gruppen att kodstugorna hade fungerat bra och att det kändes naturligt att fortsätta arbetet på detta sätt.
