...
\item Hur kan man använda prototyper för att testa och vallidera krav?
\end{itemize}
...
\subsection{Metod}
Denna del beskriver vilka metoder och verktyg som använts i detta projekt.
...
\subsubsection{Observationer}
För att få en inblick i hur operationsförberedelserna fungerar i dagsläget genomfördes ett studiebesök. Ett besök på artikellagret gav oss en inblick i kundens problem och hur det kunde lösas. De svårigheter som beskrivits blev tydligare och det blev lättare att föreställa sig en lösning på problemet. 
